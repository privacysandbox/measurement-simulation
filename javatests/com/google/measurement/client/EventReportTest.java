...
import static com.google.measurement.client.PrivacyParams.EVENT_NOISE_PROBABILITY;
import static com.google.measurement.client.PrivacyParams.INSTALL_ATTR_EVENT_NOISE_PROBABILITY;
import static com.google.measurement.client.PrivacyParams.INSTALL_ATTR_NAVIGATION_EARLY_REPORTING_WINDOW_MILLISECONDS;
import static com.google.measurement.client.PrivacyParams.INSTALL_ATTR_NAVIGATION_NOISE_PROBABILITY;
import static com.google.measurement.client.PrivacyParams.NAVIGATION_EARLY_REPORTING_WINDOW_MILLISECONDS;
import static com.google.measurement.client.PrivacyParams.NAVIGATION_NOISE_PROBABILITY;
...
public final class EventReportTest {
  ...
  private static final String EVENT_TRIGGERS =
      "[\n"
          ...
          + "}"
          + "]\n";
  private static final Map<UnsignedLong, UnsignedLong> sDebugKey = new HashMap();
  private EventReportWindowCalcDelegate mEventReportWindowCalcDelegate;
  private SourceNoiseHandler mSourceNoiseHandler;

  @Before
  public void setup() {
    sDebugKey.put(SOURCE_DEBUG_KEY, TRIGGER_DEBUG_KEY);
    mEventReportWindowCalcDelegate =
        new EventReportWindowCalcDelegate(new com.google.measurement.client.Flags());
    mSourceNoiseHandler = new SourceNoiseHandler(new Flags());
  }
  ...
  public void populateFromSourceAndTrigger_eventSourceAppDestWithoutInstallAttribution()
    ...
    Trigger trigger =
        createTriggerForTest(
            ...
            APP_DESTINATION,
            com.google.measurement.client.EventSurfaceType.APP);
    List<com.google.measurement.client.EventTrigger> eventTriggers =
        trigger.parseEventTriggers(false);
    EventReport report =
  ...
  public void populate_shouldTruncateTriggerDataWith64thBit() throws ParseException {
    ...
    List<com.google.measurement.client.EventTrigger> eventTriggers =
        trigger.parseEventTriggers(false);
    com.google.measurement.client.EventTrigger eventTrigger = spy(eventTriggers.get(0));
  ...
  public void populate_eventSourceWebDestWithoutInstallAttribution() throws ParseException {
    ...
    Trigger trigger =
        createTriggerForTest(
            baseTime + TimeUnit.SECONDS.toMillis(10),
            WEB_DESTINATION,
            com.google.measurement.client.EventSurfaceType.WEB);
    List<com.google.measurement.client.EventTrigger> eventTriggers =
        trigger.parseEventTriggers(false);
    EventReport report =
        new EventReport.Builder()
  ...
  public void populate_navigationSourceWebDestWithoutInstall() throws ParseException {
    ...
    assertEquals(
        mEventReportWindowCalcDelegate.getReportingTime(
            source, trigger.getTriggerTime(), com.google.measurement.client.EventSurfaceType.WEB),
        report.getReportTime());
    assertEquals(source.getSourceType(), report.getSourceType());
    assertEquals(NAVIGATION_NOISE_PROBABILITY, report.getRandomizedTriggerRate(), DOUBLE_MAX_DELTA);
    assertEquals(SOURCE_ID, report.getSourceId());
  ...
  public void populateFromSourceAndTrigger_flexApiNoPrevTrigger_returnsNewPriority()
    ...
    String eventTriggers1 =
        "[\n"
            ...
            + "]\n";
    Trigger trigger =
        TriggerFixture.getValidTriggerBuilder().setEventTriggers(eventTriggers1).build();
