...
public class SourceTest {
  ...
  public void testEqualsPass() {
    ...
    assertEquals(
        new Source.Builder()
            ...
            .setPublisherType(com.google.measurement.client.EventSurfaceType.WEB)
            .setId("1")
            ...
            .setRegistrationOrigin(
                com.google.measurement.client.WebUtil.validUri("https://subdomain.example.test"))
  ...
  public void testEqualsFail() {
    ...
    assertNotEquals(
        SourceFixture.getValidSourceBuilder()
            .setPublisherType(com.google.measurement.client.EventSurfaceType.APP)
            .build(),
        SourceFixture.getValidSourceBuilder()
            .setPublisherType(com.google.measurement.client.EventSurfaceType.WEB)
            .build());
    ...
    assertNotEquals(
        SourceFixture.getValidSourceBuilder()
            .setRegistrationOrigin(
                com.google.measurement.client.WebUtil.validUri("https://subdomain1.example.test"))
            .build(),
        SourceFixture.getValidSourceBuilder()
  ...
  public void testGetAttributionDestinations() {
    ...
    assertEquals(
        source.getAttributionDestinations(com.google.measurement.client.EventSurfaceType.APP),
  ...
  public void testParseFilterData_nonEmpty() throws ParseException {
    ...
    Source source =
        SourceFixture.getValidSourceBuilder()
            ...
            .build();
    com.google.measurement.client.FilterMap filterMap = source.getFilterData();
