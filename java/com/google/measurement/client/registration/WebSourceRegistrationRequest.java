...
public final class WebSourceRegistrationRequest {
  ...
  private static InputEvent mInputEvent;
  ...
  /**
   * App destination of the source. It is the android app {@link Uri} where corresponding conversion
  ...
  /**
   * Web destination of the source. It is the website {@link Uri} where corresponding conversion is
   * expected. This field is compared with the corresponding field in Source Registration Response,
   * if matching fails the registration is rejected. If null is provided, no destination matching
   * will be performed.
   */
  ...
  public static final class Builder {
    ...
    /**
     * User Interaction InputEvent used by the AttributionReporting API to distinguish clicks from
     * views.
     */
    ...
    public Builder(@NonNull List<WebSourceParams> webSourceParams, @NonNull Uri topOriginUri) {
      ...
      if (webSourceParams.isEmpty() || webSourceParams.size() > WEB_SOURCE_PARAMS_MAX_COUNT) {
        throw new IllegalArgumentException(
            "web source params size is not within bounds, size: " + webSourceParams.size());
      }
    ...
    /**
     * Setter for app destination. It is the android app {@link Uri} where corresponding conversion
    ...
    /**
     * Setter for web destination. It is the website {@link Uri} where corresponding conversion is
     * expected. At least one of app destination or web destination is required.
     *
