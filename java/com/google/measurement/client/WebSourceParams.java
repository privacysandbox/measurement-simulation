...
public final class WebSourceParams {
  ...
  public static final class Builder {
    ...
    /**
     * Builder constructor for {@link WebSourceParams}. {@code mIsDebugKeyAllowed} is assigned false
     * by default.
     *
    ...
    /**
     * Setter for debug allow/disallow flag. Setting it to true will allow parsing debug keys from
     * registration responses and their addition in the generated reports.
     *
     * @param debugKeyAllowed used by the browser to indicate whether the debug key obtained from
     *     the registration URI is allowed to be used
     * @return builder
     */
    @NonNull
