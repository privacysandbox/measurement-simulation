...
public final class LocalAggregationRunner {
  ...
  public static void runAggregator(AggregationArgs args) {
    ...
    try {
      ...
      System.err.println("IO Exception in Aggregation API.");
      e.printStackTrace();
    } catch (TimeoutException e) {
      System.err.println(
          "Aggregation API timed out. Consider increasing the aggregation duration "
              + "via --timeoutMinutes. Default value is 5 minutes.");
    }
  }
}
