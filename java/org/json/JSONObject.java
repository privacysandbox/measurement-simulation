 ...
 * methods is not specified. See <i>Effective Java, 3rd edition</i> Item 19, "Design and Document
 * for inheritance or else prohibit it" for further information.
 */
public class JSONObject {
   ...
   */
  public JSONObject(org.json.JSONTokener readFrom) throws JSONException {
    /*
   ...
   * a time.
   *
   * <p>Note that {@link #append(String, Object)} provides better semantics. In particular, the
