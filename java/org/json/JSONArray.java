...
/**
 * A dense indexed sequence of values. Values may be any mix of {@link org.json.JSONObject
 * JSONObjects}, other {@link JSONArray JSONArrays}, Strings, Booleans, Integers, Longs, Doubles,
 * {@code null} or {@link org.json.JSONObject#NULL}. Values may not be {@link Double#isNaN() NaNs},
 ...
 * {@link org.json.JSONObject}. See that class' documentation for details.
 *
 * <p><strong>Warning:</strong> this class represents null in two incompatible ways: the standard
 * Java {@code null} reference, and the sentinel value {@link org.json.JSONObject#NULL}. In
 * particular, {@code get} fails if the requested index holds the null reference, but succeeds if it
 * holds {@code JSONObject.NULL}.
 *
...
public class JSONArray {
   ...
   */
  public JSONArray(org.json.JSONTokener readFrom) throws JSONException {
    /*
   ...
   * Appends {@code value} to the end of this array.
   *
   * @param value a {@link org.json.JSONObject}, {@link JSONArray}, String, Boolean, Integer, Long,
   *     Double, {@link org.json.JSONObject#NULL}, or {@code null}. May not be {@link Double#isNaN()
   *     NaNs} or {@link Double#isInfinite() infinities}. Unsupported values are not permitted and
   *     will cause the array to be in an inconsistent state.
   * @return this array.
   */
   ...
   * reference or {@link org.json.JSONObject#NULL}.
   */
